...
public class ReportAssemblerTest {
	...
	public void testAssembleJSONReportBody() {
		...
		assembler.setReportBodyBuilder(new JSONReportBodyBuilder());
	...
	public void testAssembleXMLReportBody() {
		...
		assembler.setSaleEntry(createDummySaleEntry());
		assembler.setReportBodyBuilder(new XMLReportBodyBuilder());
		Report report = assembler.getReport();
	...
	public void testAssembleHTMLReportBody() {
		...
		assembler.setSaleEntry(createDummySaleEntry());
		assembler.setReportBodyBuilder(new HTMLReportBodyBuilder());
		Report report = assembler.getReport();
