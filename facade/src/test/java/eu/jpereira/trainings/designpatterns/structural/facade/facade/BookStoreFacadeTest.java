...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	protected BookstoreFacade createFacade() {
		DefaultBookStoreFacade bsf = new DefaultBookStoreFacade();
		bsf.setCustomerService(customerService);
		bsf.setBookService(bookService);
		bsf.setOrderingService(orderingService);
		bsf.setWharehouseService(warehouseService);
		bsf.setCustomerNotificationService(customerNotificationService);	
